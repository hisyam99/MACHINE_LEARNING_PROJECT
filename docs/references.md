...
- [COVID-QU-Ex on Kaggle](https://www.kaggle.com/datasets/anasmohammedtahir/covidqu)
...
Jika Anda menggunakan proyek ini dalam penelitian, mohon untuk mengutip:

```bibtex
@misc{machine_learning_covid19_2025,
  title={Deteksi COVID-19 pada Citra Chest X-Ray: Komparasi Machine Learning Klasik dan Deep Learning dengan LoRA},
  author={Kamil, Muhammad Hisyam and Farma, Elga Putri Tri},
  year={2025},
  institution={Universitas Muhammadiyah Malang},
  url={https://github.com/YOUR_USERNAME/MACHINE_LEARNING}
}
```
